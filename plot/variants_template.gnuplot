...
plot "data/xxxx_ntru_primeq_fgrm.dat"    using 5:4 with lines lw .5 lc rgb lc_ntru_prime notitle, \
     "data/xxxx_ntru_pow2q_fgrm.dat"     using 5:4 with lines lw .5 lc rgb lc_ntru_pow2 notitle, \
     "data/xxxx_ntru_primeq_fgm.dat"    using 5:4 with lines lw .5 lc rgb lc_hrss_prime notitle, \
     "data/xxxx_ntru_pow2q_fgm.dat"     using 5:4 with lines lw .5 lc rgb lc_hrss_pow2 notitle, \
     ...
     "data/xxxx_ntru_primeq_fgm_38.dat" using 5:4 with points pt pt_wt_38 lc rgb lc_hrss_prime title 'NTRU, prime q, fixed type 3n/8 fgm', \
     "data/xxxx_ntru_primeq_fgm_12.dat" using 5:4:(Params(1,2)) with labels hypertext point pt pt_wt_12_f lc rgb lc_fill notitle, \
     "data/xxxx_ntru_primeq_fgm_12.dat" using 5:4 with points pt pt_wt_12 lc rgb lc_hrss_prime title 'NTRU, prime q, fixed type 1n/2 fgm', \
     "data/xxxx_ntru_primeq_fgm_35.dat" using 5:4:(Params(1,2)) with labels hypertext point pt pt_wt_35_f  lc rgb lc_fill notitle, \
     "data/xxxx_ntru_primeq_fgm_35.dat" using 5:4 with points pt pt_wt_35 lc rgb lc_hrss_prime title 'NTRU, prime q, fixed type 3n/5 fgm', \
     "data/xxxx_ntru_primeq_fgm_23.dat" using 5:4:(Params(1,2)) with labels hypertext point pt pt_wt_23_f  lc rgb lc_fill notitle, \
     "data/xxxx_ntru_primeq_fgm_23.dat" using 5:4 with points pt pt_wt_23 lc rgb lc_hrss_prime title 'NTRU, prime q, fixed type 2n/3 fgm', \
     ...
     "data/xxxx_ntru_pow2q_fgm_38.dat"  using 5:4 with points pt pt_wt_38 lc rgb lc_hrss_pow2 title 'NTRU, pow2 q, fixed type 3n/8 fgm', \
     "data/xxxx_ntru_pow2q_fgm_12.dat"  using 5:4:(Params(1,2)) with labels hypertext point pt pt_wt_12_f lc rgb lc_fill notitle, \
     "data/xxxx_ntru_pow2q_fgm_12.dat"  using 5:4 with points pt pt_wt_12 lc rgb lc_hrss_pow2 title 'NTRU, pow2 q, fixed type 1n/2 fgm', \
     "data/xxxx_ntru_pow2q_fgm_35.dat"  using 5:4:(Params(1,2)) with labels hypertext point pt pt_wt_35_f  lc rgb lc_fill notitle, \
     "data/xxxx_ntru_pow2q_fgm_35.dat"  using 5:4 with points pt pt_wt_35 lc rgb lc_hrss_pow2 title 'NTRU, pow2 q, fixed type 3n/5 fgm', \
     "data/xxxx_ntru_pow2q_fgm_23.dat"  using 5:4:(Params(1,2)) with labels hypertext point pt pt_wt_23_f  lc rgb lc_fill notitle, \
     "data/xxxx_ntru_pow2q_fgm_23.dat"  using 5:4 with points pt pt_wt_23 lc rgb lc_hrss_pow2 title 'NTRU, pow2 q, fixed type 2n/3 fgm', \
...
plot "data/xxxx_sntrup_best.dat"           using 5:4 with points pt pt_sntrup  lc rgb lc_sntrup title 'Streamlined NTRU Prime', \
     "data/xxxx_sntrup_best.dat"           using 5:4:(Params3(1,2,3))   with labels hypertext point pt pt_sntrup  lc rgb "#ff9f00" notitle, \
     "data/xxxx_ntru_primeq_fgrm_best.dat" using 5:4:(Params2(1,2,3)) with labels hypertext point pt pt_wt_38_f  lc rgb lc_fill notitle, \
     "data/xxxx_ntru_primeq_fgrm_best.dat" using 5:4 with points pt pt_wt_38 lc rgb lc_ntru_prime title 'NTRU, prime q, fixed type best fgrm', \
     "data/xxxx_ntru_pow2q_fgrm_best.dat"  using 5:4:(Params2(1,2,3)) with labels hypertext point pt pt_wt_38_f  lc rgb lc_fill notitle, \
     "data/xxxx_ntru_pow2q_fgrm_best.dat"  using 5:4 with points pt pt_wt_38  lc rgb lc_ntru_pow2 title 'NTRU, pow2 q, fixed type best fgrm', \
     "data/xxxx_hrss_primeq_fw_best.dat"   using 5:4:(Params2(1,2,3)) with labels hypertext point pt pt_wt_38_f  lc rgb lc_fill notitle, \
     "data/xxxx_hrss_primeq_fw_best.dat"   using 5:4 with points pt pt_wt_38 lc rgb lc_hrss_prime title 'NTRU-HRSS, prime q, fixed weight best', \
     "data/xxxx_hrss_pow2q_fw_best.dat"    using 5:4:(Params2(1,2,3)) with labels hypertext point pt pt_wt_38_f  lc rgb lc_fill notitle, \
     "data/xxxx_hrss_pow2q_fw_best.dat"    using 5:4 with points pt pt_wt_38  lc rgb lc_hrss_pow2 title 'NTRU-HRSS, pow2 q, fixed weight best', \
     "data/xxxx_hrss_primeq.dat"           using 5:4:(Params2(1,2,3)) with labels hypertext point pt pt_u1_f lc rgb lc_fill notitle,  \
     "data/xxxx_hrss_primeq.dat"           using 5:4 with points pt pt_u1 lc rgb lc_hrss_prime_u title 'NTRU-HRSS, prime q, uniform', \
     "data/xxxx_hrss_pow2q.dat"            using 5:4 with points pt pt_u2  lc rgb lc_hrss_pow2_u title 'NTRU-HRSS, pow2 q, uniform', \
     "data/xxxx_hrss_pow2q.dat"            using 5:4:(Params2(1,2,3)) with labels hypertext point pt pt_u2 lc rgb lc_hrss_pow2_u notitle, \
