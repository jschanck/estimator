...
plot "data/sieve_all_primeq.dat"            using 5:4 with lines lc rgb "#aaaaaa" notitle, \
     ...
     "data/sieve_hrss_primeq_fw_38.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 9  lc rgb "#ffffff" notitle, \
        "data/sieve_hrss_primeq_fw_38.dat"  using 5:4 with points pt 8  lc 2 title 'NTRU-HRSS, prime q, fixed weight 3n/8', \
     "data/sieve_hrss_primeq_fw_12.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 13 lc rgb "#ffffff" notitle, \
        "data/sieve_hrss_primeq_fw_12.dat"  using 5:4 with points pt 12 lc 2 title 'NTRU-HRSS, prime q, fixed weight 1n/2', \
     "data/sieve_hrss_primeq_fw_35.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 5  lc rgb "#ffffff" notitle, \
        "data/sieve_hrss_primeq_fw_35.dat"  using 5:4 with points pt 4  lc 2 title 'NTRU-HRSS, prime q, fixed weight 3n/5', \
     "data/sieve_hrss_primeq_fw_23.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 7  lc rgb "#ffffff" notitle, \
        "data/sieve_hrss_primeq_fw_23.dat"  using 5:4 with points pt 6  lc 2 title 'NTRU-HRSS, prime q, fixed weight 2n/3', \
     "data/sieve_hrss_primeq.dat"           using 5:4:(Params(1,2)) with labels hypertext point pt 11 lc rgb "#ffffff" notitle,  \
         "data/sieve_hrss_primeq.dat"       using 5:4 with points pt 10 lc 1 title 'NTRU-HRSS, prime q, uniform', \
...
plot "data/enum_all_primeq.dat"        using 5:4 with lines lc rgb "#aaaaaa" notitle, \
     ...
     "data/enum_ntru_primeq_ft_38.dat" using 5:4 with points pt 8  lc 3 title 'NTRU, prime q, fixed type 3n/8', \
     "data/enum_ntru_primeq_ft_12.dat" using 5:4:(Params(1,2)) with labels hypertext point pt 13 lc rgb "#ffffff" notitle, \
     "data/enum_ntru_primeq_ft_12.dat" using 5:4 with points pt 12 lc 3 title 'NTRU, prime q, fixed type 1n/2', \
     "data/enum_ntru_primeq_ft_35.dat" using 5:4:(Params(1,2)) with labels hypertext point pt 5  lc rgb "#ffffff" notitle, \
     "data/enum_ntru_primeq_ft_35.dat" using 5:4 with points pt 4  lc 3 title 'NTRU, prime q, fixed type 3n/5', \
     "data/enum_ntru_primeq_ft_23.dat" using 5:4:(Params(1,2)) with labels hypertext point pt 7  lc rgb "#ffffff" notitle, \
     "data/enum_ntru_primeq_ft_23.dat" using 5:4 with points pt 6  lc 3 title 'NTRU, prime q, fixed type 2n/3', \
     "data/enum_hrss_primeq_fw_38.dat" using 5:4 with points pt 8  lc 2 title 'NTRU-HRSS, prime q, fixed weight 3n/8', \
     "data/enum_hrss_primeq_fw_12.dat" using 5:4:(Params(1,2)) with labels hypertext point pt 13 lc rgb "#ffffff" notitle, \
     "data/enum_hrss_primeq_fw_12.dat" using 5:4 with points pt 12 lc 2 title 'NTRU-HRSS, prime q, fixed weight 1n/2', \
     "data/enum_hrss_primeq_fw_35.dat" using 5:4:(Params(1,2)) with labels hypertext point pt 5  lc rgb "#ffffff" notitle, \
     "data/enum_hrss_primeq_fw_35.dat" using 5:4 with points pt 4  lc 2 title 'NTRU-HRSS, prime q, fixed weight 3n/5', \
     "data/enum_hrss_primeq_fw_23.dat" using 5:4:(Params(1,2)) with labels hypertext point pt 7  lc rgb "#ffffff" notitle, \
     "data/enum_hrss_primeq_fw_23.dat" using 5:4 with points pt 6  lc 2 title 'NTRU-HRSS, prime q, fixed weight 2n/3', \
     "data/enum_hrss_primeq.dat"       using 5:4:(Params(1,2)) with labels hypertext point pt 11 lc rgb "#ffffff" notitle,  \
     "data/enum_hrss_primeq.dat"       using 5:4 with points pt 10 lc 1 title 'NTRU-HRSS, prime q, uniform', \
     "data/enum_hrss_pow2q.dat"        using 5:4 with points pt 3  lc 7 title 'NTRU-HRSS, pow2 q, uniform', \
...
set terminal svg enhanced mouse standalone font "arial,10" size plotw, ploth
set output 'variants_primeq_vs_sntrup_sieve.svg'
...
set terminal svg enhanced mouse standalone font "arial,10" size plotw, ploth
set output 'variants_primeq_vs_sntrup_enum.svg'
...
set arrow 3 from sntrup4591761_bytes-250,sntrup4591761_enumcost+5 to sntrup4591761_bytes-20,sntrup4591761_enumcost+.5
set label 3 "sntrup4591761" at sntrup4591761_bytes-450,sntrup4591761_enumcost+6

set arrow 1 from ntruhrss701_bytes+150, ntruhrss701_enumcost-5 to ntruhrss701_bytes+25, ntruhrss701_enumcost+1
set label 2 "ntruhrss701" at ntruhrss701_bytes+150, ntruhrss701_enumcost-6

plot "data/enum_ntru_primeq_ft.dat"    using 5:4 with lines    lc rgb "#aaaaaa" notitle, \
     "data/enum_sntrup.dat"            using 5:4      with lines    lt rgb "#cccccc" notitle, \
     "data/enum_ntru_primeq_ft_38.dat" using 5:4:(Params(1,2)) with labels hypertext point pt 9  lc rgb "#ffffff" notitle, \
     "data/enum_ntru_primeq_ft_38.dat" using 5:4 with points   pt 8  lc 3 title 'NTRU, prime q,  fixed type 3n/8', \
     "data/enum_ntru_primeq_ft_12.dat" using 5:4:(Params(1,2)) with labels hypertext point pt 13 lc rgb "#ffffff" notitle, \
     "data/enum_ntru_primeq_ft_12.dat" using 5:4 with points   pt 12 lc 3 title 'NTRU, prime q,  fixed type 1n/2', \
     ...
     "data/enum_ntru_primeq_ft_23.dat" using 5:4:(Params(1,2)) with labels hypertext point pt 7  lc rgb "#ffffff" notitle, \
     "data/enum_ntru_primeq_ft_23.dat" using 5:4 with points   pt 6  lc 3 title 'NTRU, prime q,  fixed type 2n/3', \
     "data/enum_sntrup.dat"            using 5:4 with points        pt 2  lc rgb "#ff9f00" title 'Streamlined NTRU Prime, prime q, various weights',                \
     "data/enum_sntrup.dat"            using 5:4:(Params3(1,2,3))   with labels hypertext point pt 2  lc rgb "#ff9f00" notitle, \
     "data/enum_hrss_primeq.dat"       using 5:4:(Params(1,2)) with labels hypertext point pt 11 lc rgb "#ffffff" notitle,  \
     "data/enum_hrss_primeq.dat"       using 5:4 with points   pt 10 lc 1 title 'NTRU-HRSS, prime q,   uniform trinary', \
     "data/enum_hrss_pow2q.dat"        using 5:4 with points   pt 3  lc 7 title 'NTRU-HRSS, pow2 q,   uniform trinary', \
     "data/enum_hrss_pow2q.dat"        using 5:4:(Params(1,2)) with labels hypertext point pt 3  lc rgb "#ff0000" notitle, \
...
# Data is input twice. First for mouse over text, then for points
plot "data/sieve_hrss_primeq_p2.dat"    using 5:4 with points pt 2 lc 1 title 'NTRU-HRSS, prime q, p=2', \
        "data/sieve_hrss_primeq_p3.dat" using 5:4 with points pt 4 lc 2 title 'NTRU-HRSS, prime q, p=3', \
        "data/sieve_hrss_primeq_p4.dat" using 5:4 with points pt 6 lc 3 title 'NTRU-HRSS, prime q, p=4', \
        "data/sieve_hrss_primeq_p5.dat" using 5:4 with points pt 8 lc 4 title 'NTRU-HRSS, prime q, p=5', \
...
# Data is input twice. First for mouse over text, then for points
plot "data/enum_hrss_primeq_p2.dat" using 5:4 with points pt 2 lc 1 title 'NTRU-HRSS, prime q, p=2', \
     "data/enum_hrss_primeq_p3.dat" using 5:4 with points pt 4 lc 2 title 'NTRU-HRSS, prime q, p=3', \
     "data/enum_hrss_primeq_p4.dat" using 5:4 with points pt 6 lc 3 title 'NTRU-HRSS, prime q, p=4', \
     "data/enum_hrss_primeq_p5.dat" using 5:4 with points pt 8 lc 4 title 'NTRU-HRSS, prime q, p=5', \
...
set terminal svg enhanced mouse standalone font "arial,10" size plotw, ploth
set output 'variants_pow2_sieve.svg'
...
set terminal svg enhanced mouse standalone font "arial,10" size plotw, ploth
set output 'variants_pow2_enum.svg'
...
plot "data/enum_hrss_pow2q_fw_38.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 9  lc rgb "#ffffff" notitle, \
     "data/enum_ntru_pow2q_ft_38.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 9  lc rgb "#ffffff" notitle, \
        "data/enum_ntru_pow2q_ft_38.dat"  using 5:4 with points pt 8  lc 3 title 'NTRU, pow2 q, fixed type 3n/8', \
     "data/enum_ntru_pow2q_ft_12.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 13 lc rgb "#ffffff" notitle, \
        "data/enum_ntru_pow2q_ft_12.dat"  using 5:4 with points pt 12 lc 3 title 'NTRU, pow2 q, fixed type 1n/2', \
     "data/enum_ntru_pow2q_ft_35.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 5  lc rgb "#ffffff" notitle, \
        "data/enum_ntru_pow2q_ft_35.dat"  using 5:4 with points pt 4  lc 3 title 'NTRU, pow2 q, fixed type 3n/5', \
     "data/enum_ntru_pow2q_ft_23.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 7  lc rgb "#ffffff" notitle, \
        "data/enum_ntru_pow2q_ft_23.dat"  using 5:4 with points pt 6  lc 3 title 'NTRU, pow2 q, fixed type 2n/3', \
        "data/enum_hrss_pow2q_fw_38.dat"  using 5:4 with points pt 8  lc 2 title 'NTRU-HRSS, pow2 q, fixed weight 3n/8', \
     "data/enum_hrss_pow2q_fw_12.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 13 lc rgb "#ffffff" notitle, \
        "data/enum_hrss_pow2q_fw_12.dat"  using 5:4 with points pt 12 lc 2 title 'NTRU-HRSS, pow2 q, fixed weight 1n/2', \
     "data/enum_hrss_pow2q_fw_35.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 5  lc rgb "#ffffff" notitle, \
        "data/enum_hrss_pow2q_fw_35.dat"  using 5:4 with points pt 4  lc 2 title 'NTRU-HRSS, pow2 q, fixed weight 3n/5', \
     "data/enum_hrss_pow2q_fw_23.dat"     using 5:4:(Params(1,2)) with labels hypertext point pt 7  lc rgb "#ffffff" notitle, \
        "data/enum_hrss_pow2q_fw_23.dat"  using 5:4 with points pt 6  lc 2 title 'NTRU-HRSS, pow2 q, fixed weight 2n/3', \
     "data/enum_hrss_pow2q.dat"           using 5:4 with points pt 3  lc 7 title 'NTRU-HRSS, pow2 q, uniform', \
        "data/enum_hrss_pow2q.dat"        using 5:4:(Params(1,2)) with labels hypertext point pt 3  lc rgb "#ff0000" notitle, \
