...
plot "data/enum_prime_all.dat"     using (2*$5):4 with lines lc rgb "#aaaaaa" notitle, \
     "data/enum_prime_38.dat"  using (2*$5):4:(Params(1,2)) with labels hypertext point pt 9  lc rgb "#ffffff" notitle, \
        "data/enum_prime_38.dat"  using (2*$5):4 with points pt 8  lc 2 title 'prime q, fixed weight 3n/8', \
     "data/enum_prime_12.dat"  using (2*$5):4:(Params(1,2)) with labels hypertext point pt 13 lc rgb "#ffffff" notitle, \
        "data/enum_prime_12.dat"  using (2*$5):4 with points pt 12 lc 2 title 'prime q, fixed weight 1n/2', \
     "data/enum_prime_35.dat"  using (2*$5):4:(Params(1,2)) with labels hypertext point pt 5  lc rgb "#ffffff" notitle, \
        "data/enum_prime_35.dat"  using (2*$5):4 with points pt 4  lc 2 title 'prime q, fixed weight 3n/5', \
     "data/enum_prime_23.dat"  using (2*$5):4:(Params(1,2)) with labels hypertext point pt 7  lc rgb "#ffffff" notitle, \
        "data/enum_prime_23.dat"  using (2*$5):4 with points pt 6  lc 2 title 'prime q, fixed weight 2n/3', \
     "data/enum_hrss_prq.dat" using (2*$4):3:(Params(1,2)) with labels hypertext point pt 11 lc rgb "#ffffff" notitle,  \
         "data/enum_hrss_prq.dat" using (2*$4):3 with points pt 10 lc 1 title 'prime q, uniform', \
     "data/enum_hrss.dat"     using (2*$4):3 with points pt 3  lc 7 title 'NTRU-HRSS', \
        "data/enum_hrss.dat"     using (2*$4):3:(Params(1,2)) with labels hypertext point pt 3  lc rgb "#ff0000" notitle, \
...
# Data is input twice. First for mouse over text, then for points
plot "data/sieve_hrss_prq_p2.dat" using (2*$4):3 with points pt 2 lc 1 title 'p=2', \
        "data/sieve_hrss_prq.dat" using (2*$4):3 with points pt 4 lc 2 title 'p=3', \
        "data/sieve_hrss_prq_p4.dat" using (2*$4):3 with points pt 6 lc 3 title 'p=4', \
        "data/sieve_hrss_prq_p5.dat" using (2*$4):3 with points pt 8 lc 4 title 'p=5', \
...
# Data is input twice. First for mouse over text, then for points
plot "data/enum_hrss_prq_p2.dat" using (2*$4):3 with points pt 2 lc 1 title 'p=2', \
        "data/enum_hrss_prq.dat" using (2*$4):3 with points pt 4 lc 2 title 'p=3', \
        "data/enum_hrss_prq_p4.dat" using (2*$4):3 with points pt 6 lc 3 title 'p=4', \
        "data/enum_hrss_prq_p5.dat" using (2*$4):3 with points pt 8 lc 4 title 'p=5', \
