...
for(i=1, #ns_pow2q, n = ns_pow2q[i]; \
  enum_data  = matconcat([enum_data;  data_hrss_pow2q(n,BKZ_ENUM_MODEL,hybrid=1)]); \
  sieve_data = matconcat([sieve_data; data_hrss_pow2q(n,BKZ_SIEVE_MODEL,hybrid=0)]));
...
for(i=1, #ns_primeq_p3, n = ns_primeq_p3[i]; \
  enum_data  = matconcat([enum_data;  data_hrss_primeq(n,BKZ_ENUM_MODEL,hybrid=1)]); \
  sieve_data = matconcat([sieve_data; data_hrss_primeq(n,BKZ_SIEVE_MODEL,hybrid=0)]));
write_data(concat("enum_",fn), enum_data);
write_data(concat("sieve_",fn), sieve_data);
write_best(concat("enum_",fn), enum_data);
write_best(concat("sieve_",fn), sieve_data);
...
for(i=1, #ns_pow2q, n = ns_pow2q[i]; \
  for(j=1, #wts, wt = wts[j]; \
    enum_data  = matconcat([enum_data;  data_hrss_pow2q_fixedwt(n,wt,BKZ_ENUM_MODEL,hybrid=1)]); \
    sieve_data = matconcat([sieve_data; data_hrss_pow2q_fixedwt(n,wt,BKZ_SIEVE_MODEL,hybrid=0)])));
write_data(concat("enum_",fn), enum_data);
write_data(concat("sieve_",fn), sieve_data);
...
for(i=1, #ns_primeq_p3, n = ns_primeq_p3[i]; \
  for(j=1, #wts, wt = wts[j]; \
    enum_data  = matconcat([enum_data;  data_hrss_primeq_fixedwt(n,wt,BKZ_ENUM_MODEL,hybrid=1)]); \
    sieve_data = matconcat([sieve_data; data_hrss_primeq_fixedwt(n,wt,BKZ_SIEVE_MODEL,hybrid=0)])));
write_data(concat("enum_",fn), enum_data);
write_data(concat("sieve_",fn), sieve_data);
write_wt_filtered(concat("enum_",fn), wts, enum_data);
write_wt_filtered(concat("sieve_",fn), wts, sieve_data);
...
for(i=1, #ns_primeq_p2, n = ns_primeq_p2[i]; \
  enum_data  = matconcat([enum_data;  data_hrss_primeq_unifp(n,2,BKZ_ENUM_MODEL,hybrid=1)]); \
  sieve_data = matconcat([sieve_data; data_hrss_primeq_unifp(n,2,BKZ_SIEVE_MODEL,hybrid=0)]));
write_data(concat("enum_",fn), enum_data);
write_data(concat("sieve_",fn), sieve_data);
...
sieve_data = [];
for(i=1, #ns_primeq_p3, n = ns_primeq_p3[i]; \
  enum_data  = matconcat([enum_data;  data_hrss_primeq_unifp(n,3,BKZ_ENUM_MODEL,hybrid=1)]); \
  sieve_data = matconcat([sieve_data; data_hrss_primeq_unifp(n,3,BKZ_SIEVE_MODEL,hybrid=0)]));
write_data(concat("enum_",fn), enum_data);
write_data(concat("sieve_",fn), sieve_data);
...
for(i=1, #ns_primeq_p5, n = ns_primeq_p5[i]; \
  enum_data  = matconcat([enum_data;  data_hrss_primeq_unifp(n,5,BKZ_ENUM_MODEL,hybrid=1)]); \
  sieve_data = matconcat([sieve_data; data_hrss_primeq_unifp(n,5,BKZ_SIEVE_MODEL,hybrid=0)]));
write_data(concat("enum_",fn), enum_data);
write_data(concat("sieve_",fn), sieve_data);
...
for(i=1, #ns_pow2q, n = ns_pow2q[i]; \
  for(j=1, #wts, wt = wts[j]; \
    enum_data  = matconcat([enum_data;  data_ntru_pow2q(n,wt,BKZ_ENUM_MODEL,hybrid=1)]); \
    sieve_data = matconcat([sieve_data; data_ntru_pow2q(n,wt,BKZ_SIEVE_MODEL,hybrid=0)])));
write_data(concat("enum_",fn), enum_data);
write_data(concat("sieve_",fn), sieve_data);
write_wt_filtered(concat("enum_",fn), wts, enum_data);
write_wt_filtered(concat("sieve_",fn), wts, sieve_data);
...
for(i=1, #ns_primeq_p3, n = ns_primeq_p3[i]; \
  for(j=1, #wts, wt = wts[j]; \
    enum_data  = matconcat([enum_data;  data_ntru_primeq(n,wt,BKZ_ENUM_MODEL,hybrid=1)]); \
    sieve_data = matconcat([sieve_data; data_ntru_primeq(n,wt,BKZ_SIEVE_MODEL,hybrid=0)])));
write_data(concat("enum_",fn), enum_data);
write_data(concat("sieve_",fn), sieve_data);
write_wt_filtered(concat("enum_",fn), wts, enum_data);
write_wt_filtered(concat("sieve_",fn), wts, sieve_data);
...
for(i=1, matsize(sntrup_params_all)[1], \
  ...
  enum_data  = matconcat([enum_data;  data_sntrup(n,q,t,BKZ_ENUM_MODEL,hybrid=1)]); \
  sieve_data = matconcat([sieve_data; data_sntrup(n,q,t,BKZ_SIEVE_MODEL,hybrid=0)])));
...
for(i=1, matsize(ees_params)[1], \
  [n,q,d] = ees_params[i,]; \
  enum_data  = matconcat([enum_data;  data_ees(n,q,d,BKZ_ENUM_MODEL,hybrid=1)]); \
  sieve_data = matconcat([sieve_data; data_ees(n,q,d,BKZ_SIEVE_MODEL,hybrid=0)]));
write_data(concat("enum_",fn), enum_data);
write_data(concat("sieve_",fn), sieve_data);
